...
export const useDialogStore = defineStore('dialog', () => {
  ...
  const errorInfo = {
    ...
    404: {
      title: '找不到資料',
      message: '找不到請求的資料，請洽服務人員協助。',
    },
    500: {
      title: '未預期錯誤',
      message: '發生未預期錯誤，請洽服務人員協助。',
    }
  }
  ...
  return { dialogIsOpen, dialogIsShow, dialogStatus, dialogTitle, dialogInfo, dialogTarget, dialogData, openDialog, errorHandle }
})
